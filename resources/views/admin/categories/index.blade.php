    ...
    <div class="content">
        <div class="container">
            ...
            @foreach ($categories as $category)
                ...
                <option value="{{$category->id}}"><nav class="">{{$category->name}}</nav>
            ...
            <a href="" data-toggle="modal" data-target="#exampleModal"><option value="{{$category->id}}">
                Добавить категорию +</option></a>
            </a>          
                </div>
